...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (validateDates($date_debut_contrat, $date_fin_contrat)) {
        $sql = "INSERT INTO clients (nom, type_client, email, telephone, adresse_postale, situation_geographique, date_debut_contrat, date_fin_contrat) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $pdo->prepare($sql);
        $stmt->execute([$nom, $type_client, $email, $telephone, $adresse_postale, $situation_geographique, $date_debut_contrat, $date_fin_contrat]);
...
<body>
    <div class="container mt-5">
        ...
        <form method="post" action="create.php" class="needs-validation" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="situation_geographique" name="situation_geographique" required>
    ...
    <script>
        ...
        (function() {
            'use strict';
            window.addEventclientner('load', function() {
